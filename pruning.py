...
def train_prune_net(net,
    ...
    for epoch in range(epochs):
        ...
        for i, b in enumerate(val):
            ...
            print('Validation Dice Coeff at batch {}: {}'.format(i+1, val_dice))
...
if __name__ == '__main__':
    ...
    # Activate flags for pruning in prunable layers
    net.set_pruning()
